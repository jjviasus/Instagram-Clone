...
//  InstagramFirestore
//
//  Created by Justin Viasus on 3/13/21.
//
...
// similar to an interface (lets us know that we HAVE to implement these properties if we are conforming to the protocol)
